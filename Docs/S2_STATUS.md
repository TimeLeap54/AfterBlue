...
The current milestone is not final art placement. It is a readability blockout for map size, boat speed, landmark scale, and zone distance.

This corresponds to Week 6 Map_01 in `MAP_01_FULL_PIPELINE.md`: the 192 x 128m candidate is active and the Week 6 readability pass adds large readable habitat fields plus Week5-style proxies.
...
- Week 6 readability replaces small yellow dots with large color-coded area fields.
- Week 6 readability adds Start/H1/M/H2/H3/D proxy clusters for camera readability.
...
Open the Week 6 readability scene, play it with the current boat camera, and record whether H1/H2/H3/Start read as real destinations at 192 x 128m.
