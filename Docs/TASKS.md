...
- [x] Relax Week7 generation so water material remains visible even if the water prefab or boat model load path is temporarily unavailable.
- [x] Add a small Flooded Grounds selected asset pass under Week7 landmarks.
